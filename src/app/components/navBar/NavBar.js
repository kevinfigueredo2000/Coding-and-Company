    ...
    return (
        < >
            <div id="nav-bar" ref={BgNav}>
                <a href="#index"><Image href="/assets/white-arrow.svg" ref={ToTop} alt="white-arrow" className="d-none" id="to-top" /></a>
                <Row>
                    <ul className="nav justify-content-end" style={{width:"80%"}}>
                        <li className="nav-item col-2 me-5">
                            <a href="#index">
                                <Image href="/assets/iso.svg" ref={Iso} alt="iso" className="iconos-nav" />
                                <Image href="/assets/logo.svg" ref={Logo} alt="logo" className="d-none" />
                            </a>
                        </li>
                        <li className=" px-4 my-auto" onMouseEnter={handleShow}>
                            <Image href="/assets/hex-blue.svg" alt="hex-blue" className={`${display} hex-blue-nav`} />
                            <a href="">Cursos</a>
                        </li>
                        <li className=" px-4 my-auto" onMouseEnter={handleShow}>
                            <Image href="/assets/hex-blue.svg" alt="hex-blue" className={`${display} hex-blue-nav`} />
                        ...
                        <li className="mx-4">
                            <a href=""><Image href="/assets/email.svg" alt="email" className="iconos-nav" /></a>
                        </li>
                        <li className=" mx-4">
                            <a href=""><Image href="/assets/instagram.svg" alt="instagram" className="iconos-nav" /></a>
                        </li>
                        <li className="mx-4">
                            <a href=""><Image href="/assets/globe.svg" alt="globe" className="iconos-nav" /></a>
                        </li>
                    </ul>
                </Row>
            </div>
